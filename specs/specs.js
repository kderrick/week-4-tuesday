...
describe('Address',function() {
  it("creates a new address with the given specifications",function(){
    var testAddress = new Address("Billing", "123 Main St", "Test City", "Test State");
    expect(testAddress.variety).to.equal("Billing");
  ...
  it("add the fullAddress method to all addresses", function() {
    var testAddress = new Address("Billing", "123 Main St", "Test City", "Test State");
    expect(testAddress.fullAddress()).to.equal("Billing: 123 Main St, Test City, Test State");
  });
});
